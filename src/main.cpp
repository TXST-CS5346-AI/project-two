...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Authors: \033[0;31m David Torrente (dat54@txstate.edu), Randall Henderson (rrh93@txstate.edu), "
              << "Borislav Sabotinov (bss64@txstate.edu).\033[0m" << std::endl;
    ...
    std::cout << "NOTE: If Y is selected below, you will NOT be prompted further for any eval function or alg. "
